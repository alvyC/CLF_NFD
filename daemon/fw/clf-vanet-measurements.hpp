...
public:
  ...
  void 
  updateLocation(ndn::Name, ndn::Location);
...
public:
  ...
  void
  updateScoreAndLocation(const fib::Entry& fibEntry, ndn::Name namePrefix, ndn::Name annPrefix, ndn::Location destLocation, FaceId faceId);
...
public:
  static constexpr time::microseconds SCORE_DECAY_TIME = 10_s;
  static constexpr double R = 0.9;
  static constexpr time::microseconds MEASUREMENTS_LIFETIME = 3000_s;
